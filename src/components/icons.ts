...
// ─── Additional icons needed for full lucide-react migration ───────
export { PauseCircle } from '@phosphor-icons/react';
export { PlayCircle } from '@phosphor-icons/react';
...
export { ArrowBendDownLeft as CornerDownLeft } from '@phosphor-icons/react';
